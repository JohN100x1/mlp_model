...
class MLP_MODEL:
    ...
    def __init__(self, input_size):
        ...
        Parameters
        ----------
        model : List, contains DenseLayer object classes
        """
    ...
    def train(self, X_train, y_train, X_val, y_val, batch_size=128, epochs=40, learning_rate=0.01):
        """
        ...
        for epoch in range(epochs):
            ...
            print("Epoch:", epoch, "Time taken:", time_taken, "train/val loss:", losses[:,epoch],"train/val acc:", accuracies[:,epoch])
